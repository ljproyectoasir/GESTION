...
ORIGENES=( /etc/init.d/ /etc/bind/ /var/cache/bind/ /etc/nagios-nrpe/ /etc/network/interfaces /etc/resolv.conf /var/log/ /root/scripts/ /home/web/ )

# Destinos del backup (array) dentro de /backups/daily/
DESTINOS=( servicios bind bind-zone nrpe conf-ip resolver logs scripts web )
...
DESTINO='/backups/daily/gestion01/'
IPBACKUP1='varys.got'
